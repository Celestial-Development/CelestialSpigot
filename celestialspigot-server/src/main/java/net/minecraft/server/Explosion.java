...
public class Explosion {
    ...
    public void a() {
        ...
        if (!CelestialSpigot.INSTANCE.getConfig().isOptimizeLiquidExplosions() || !block.getMaterial().isLiquid()) { // PandaSpigot - skip calculating what blocks to blow up in water/lava
        for (int k = 0; k < 16; ++k) {
            for (i = 0; i < 16; ++i) {
                for (j = 0; j < 16; ++j) {
