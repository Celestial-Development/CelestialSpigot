            ...
            if(args.length == 0) {
                ...
                switch (args[0].toLowerCase()) {
                    case "multiplier": {
                        ...
                        KewlSpigot.INSTANCE.getConfig().setPotionFallSpeed(Float.parseFloat(args[1]));
                    ...
                    case "offset": {
                        ...
                        KewlSpigot.INSTANCE.getConfig().setPotionThrowOffset(Float.parseFloat(args[1]));
                    ...
                    case "smooth": {
                        ...
                        KewlSpigot.INSTANCE.getConfig().setSmoothHealPotions(Boolean.parseBoolean(args[1]));
